...
function generateOrg1TLSCryptoMaterials() {
    ...
    fabric-ca-client enroll -u https://tlsadmin:tlsadminpw@localhost:7054 --caname tls.ca.org1.example.com -M msp --tls.certfiles ${PWD}/fabric-ca/org1.example.com/tls.ca/ca-cert.pem
...
function generateOrg2TLSCryptoMaterials() {
    ...
    fabric-ca-client enroll -u https://tlsadmin:tlsadminpw@localhost:8054 --caname tls.ca.org2.example.com -M msp --tls.certfiles ${PWD}/fabric-ca/org2.example.com/tls.ca/ca-cert.pem
...
function generateOrdererTLSCryptoMaterials() {
    ...
    fabric-ca-client enroll -u https://tlsadmin:tlsadminpw@localhost:9054 --caname tls.ca.orderer.example.com -M msp --tls.certfiles ${PWD}/fabric-ca/orderer.example.com/tls.ca/ca-cert.pem
    ...
    # Admin register
    fabric-ca-client register -u https://localhost:9054 --caname tls.ca.orderer.example.com --id.name org2admin --id.secret org2adminpw --id.type admin --id.attrs '"hf.Registrar.Roles=admin"' --tls.certfiles ${PWD}/fabric-ca/orderer.example.com/tls.ca/ca-cert.pem
    
    # Admin TLS
    fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:9054 --caname tls.ca.orderer.example.com -M ${PWD}/crypto-config/ordererOrganizations/example.com/users/Admin@org2.example.com/tls --enrollment.profile tls --tls.certfiles ${PWD}/fabric-ca/orderer.example.com/tls.ca/ca-cert.pem
